<x-guest-layout>
    <x-auth-card>
        <x-splade-form action="{{ route('register') }}" class="space-y-4">
            <x-splade-input id="company_name" type="text" name="company_name" :label="__('Company')" required autofocus />
            <x-splade-input id="name" type="text" name="name" :label="__('Contact Person')" required />
            <x-splade-input id="email" type="email" name="email" :label="__('Contact Person\'s Email')" required />
