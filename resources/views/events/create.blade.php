<x-app-layout>
    <x-splade-modal>
        <x-splade-form :default="[
            ...
            'at' => null,
            'location' => null,
            'target' => \App\Models\Event::TARGET_VISITOR,
            'visible_by_target' => false,
            'thumbnail' => null,
        ]" :action="route('events.store')" method="POST">
            ...
            <x-hint text="You can add group after you created the event." />
            <x-splade-submit class="mt-4 p-2 w-full rounded">
                Save
            </x-splade-submit>
        </x-splade-form>
    </x-splade-modal>
