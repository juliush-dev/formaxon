<section class="space-y-6">
    ...
    <Link href="#confirm-user-deletion" dusk="open-delete-modal"
        class="inline-flex rounded-md shadow-sm bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline">
    {{ __('Delete Account') }}
    </Link>

    <x-splade-modal name="confirm-user-deletion">
        <x-splade-form dusk="confirm-user-deletion" method="delete" :action="route('profile.destroy', $user)">
            <h2 class="text-lg font-medium text-gray-900">
